...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <?php
    $this->load->view('common/error_message');
    ?>
    <form action="admin/" method="post"  id="admin_login" class="admin_login">
      <div class="form-group has-feedback">
        <input type="email" name="email_id" class="form-control" value="admin@admin.com" placeholder="Email">
